...
import img5 from '../../public/img/Livro4.jpg'
import img6 from '../../public/img/Livro5.jpg'
import img7 from '../../public/img/Livro6.jpg'
import img8 from '../../public/img/Livro7.jpg'
    ...
    <div className="card">
      <div className="card-body">
        <h5 className="card-title">CORALINE - ACOMPANHA MARCADOR DE PÁGINAS ESPECIAL</h5>
         <Image src={img5} height={700} width={750}/>
      </div>
    </div>
  </div>
  <div className="col-sm-3">
